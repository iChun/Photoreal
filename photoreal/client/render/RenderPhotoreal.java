...
public class RenderPhotoreal extends Render 
{
	...
	public void renderPhotoreal(EntityPhotoreal photo, double d, double d1, double d2, float f, float f1)
	{
		if(photo.tex != null)
		{
			...
			if(photo.screenWidth == 0 || photo.screenHeight == 0)
			{
				photo.screenWidth = mc.displayWidth;
				photo.screenHeight = mc.displayHeight;
	            photo.tex.updateResolution(photo.screenWidth, photo.screenHeight);
			}
	...
	//			System.out.println(height);
				...
				GL11.glBindTexture(GL11.GL_TEXTURE_2D, photo.tex.texture);
